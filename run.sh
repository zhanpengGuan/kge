...
# python kge/cli_debug.py models/WNRR18/AdaE_auto.yaml cuda:1 '[1,80]'  0.5 0.35 '[-1]' 128 2 0.01 &
# python kge/cli_debug.py models/WNRR18/AdaE_auto.yaml cuda:5 '[64,80]'  0.5 0.25 '[-1]' 128 2 0.01 &
# python kge/cli_debug.py models/WNRR18/AdaE_auto.yaml cuda:7 '[1,80]'  0.5 0.45 '[-1]' 128 2 0.01 &
# python kge/cli_debug.py models/WNRR18/AdaE_auto.yaml cuda:7 '[1,80]'  0.5 0.36 '[-1]' 256 2 0.01 &
# wait
# python kge/cli_debug.py models/WNRR18/AdaE_auto.yaml cuda:2 '[1,80]'  0.5 0.36 '[-1]' 512 2 0.01 &
# python kge/cli_debug.py models/WNRR18/AdaE_auto.yaml cuda:7 '[1,80]'  0.5 0.36 '[-1]' 128 2 0.01 &
# wait
# python kge/cli_debug.py models/WNRR18/AdaE_auto.yaml cuda:0 '[1,80]'  0.5 0.35 '[-1]' 512 2 0.01 &
# python kge/cli_debug.py models/WNRR18/AdaE_auto.yaml cuda:1 '[1,80]'  0.5 0.35 '[-1]' 256 2 0.01 &
# python kge/cli_debug.py models/WNRR18/AdaE_auto.yaml cuda:2 '[1,80]'  0.5 0.35 '[-1]' 1024 2 0.01 &
# python kge/cli_debug.py models/WNRR18/AdaE_auto.yaml cuda:7 '[64,80]'  0.5 0.25 '[-1]' 256 2 0.01 &
# python kge/cli_debug.py models/fb15k-237/AdaE_auto.yaml cuda:4 '[1,80]'  0.1 0.5 '[-1]' 512 2 0.01 &
# python kge/cli_debug.py models/fb15k-237/AdaE_auto.yaml cuda:6 '[1,80]'  0.5 0.5 '[-1]' 512 2 0.01 &
# python kge/cli_debug.py models/fb15k-237/AdaE_auto.yaml cuda:7 '[1,80]'  0.25 0.5 '[-1]' 512 2 0.01 &
# python kge/cli_debug.py models/fb15k-237/AdaE_auto.yaml cuda:2 '[1,80]'  0.5 0.5 '[-1]' 512 2 0.01 &
# python kge/cli_debug.py models/fb15k-237/AdaE_auto.yaml cuda:0 '[1,80]'  0.5 0.5 '[-1]' 512 2 0.01 &
# python kge/cli_debug.py models/fb15k-237/AdaE_auto.yaml cuda:7 '[1,80]'  0.5 0.5 '[-1]' 512 2 0.01 &
# wait
# python kge/cli_debug.py models/WNRR18/AdaE_auto.yaml cuda:2 '[1,256]'  0.5 0.36 '[-1]' 256 2 0.01 &
# python kge/cli_debug.py models/fb15k-237/AdaE_auto.yaml cuda:3 '[1,256]'  0.5 0.5 '[-1]' 256 2 0.01 &
# python kge/cli_debug.py models/YAGO/AdaE_auto.yaml cuda:4 "[1,512]" 0.5 0.1 "[-1]" 512 2 0.01 &
# wait
# python kge/cli_debug.py models/WNRR18/conve_auto.yaml cuda:3 '[1,80]'  0.5 0.36 '[-1]' 512 2 0.01 &
# python kge/cli_debug.py models/fb15k-237/AdaE_auto.yaml cuda:6 '[1,128]'  0.5 0.36 '[-1]' 128 2 0.01 &
# python kge/cli_debug.py models/fb15k-237/AdaE_auto.yaml cuda:6 '[1,256]'  0.5 0.36 '[-1]' 256 2 0.01 &
# python kge/cli_debug.py models/WNRR18/AdaE_auto.yaml cuda:6 '[1,512]'  0.5 0.36 '[-1]' 256 2 0.01 &
# python kge/cli_debug.py models/fb15k-237/AdaE_auto.yaml cuda:4 '[1,1024]'  0.5 0.0 '[-1]' 1024 2 0.01 &

# python kge/cli_debug.py models/WNRR18/AdaE_auto.yaml cuda:6 '[1,1024]'  0.5 0.2 '[-1]' 1024 2 0.01 &
# python kge/cli_debug.py models/YAGO/AdaE_auto.yaml cuda:6 '[1,128]'  0.5 0.36 '[-1]' 128 2 0.01 &
# wait
# python kge/cli_debug.py models/YAGO/AdaE_auto-base.yaml cuda:4 '[1,256]'  0.5 0.36 '[-1]' 2048 2 0.01 &
# python kge/cli_debug.py models/YAGO/AdaE_auto-base.yaml cuda:7 '[1,1024]'  0.5 0.36 '[-1]' 1024 2 0.01 &
...
# python kge/cli_debug.py models/fb15k-237/transe_auto.yaml cuda:4 '[1,80]'  0.000001 0.36 '[-1]' 128 2 0.01 &
# python kge/cli_debug.py models/YAGO/transe_auto.yaml cuda:2 "[1,128]" 0.5 0.1 "[-1]" 128 2 0.01 &
# python kge/cli_debug.py models/fb15k-237/distmult_auto.yaml cuda:4 '[1,80]'  0.5 0.36 '[-1]' 256 2 0.01 &

wait

# python kge/cli_debug.py models/fb15k-237/AdaE_auto.yaml cuda:4 '[1,80]'  0.5 0.45 '[-1]' 192 2 0.01 &
# python kge/cli_debug.py models/fb15k-237/AdaE_rank.yaml cuda:2 '[128,256]'  0.5 0.5 '[0.2]' 256 2 0.01 &
# # wait
# python kge/cli_debug.py models/WNRR18/AdaE_rank.yaml cuda:3 '[32,64,128,256]'  0.5 0.36 '[0.1,0.3,0.5]' 256  &
# python kge/cli_debug.py models/WNRR18/AdaE_rank.yaml cuda:2 '[64,80]'  0.5 0.36 '[0.2]' 80  &
# python kge/cli_debug.py models/WNRR18/AdaE_rank.yaml cuda:4 '[64,80]'  0.5 0.36 '[0.2]' 80  &
# python kge/cli_debug.py models/WNRR18/AdaE_rank.yaml cuda:4 '[64,128]'  0.5 0.3 '[0.2]' 128  &
# wait
# python kge/cli_debug.py models/WNRR18/AdaE_rank.yaml cuda:2 '[64,128]'  0.5 0.4 '[0.2]' 128  &
# python kge/cli_debug.py models/WNRR18/AdaE_rank.yaml cuda:3 '[64,128]'  0.5 0.5 '[0.2]' 128  &
# python kge/cli_debug.py models/WNRR18/AdaE_rank.yaml cuda:4 '[64,128]'  0.5 0.6 '[0.2]' 128  &
# # # YAGO-3
# python kge/cli_debug.py models/YAGO/AdaE_rank.yaml cuda:1 "[64,128,256,512]" 0.5 0.1 "[0.2,0.5,0.8]" 512 2 0.01 &
# python kge/cli_debug.py models/YAGO/AdaE_auto.yaml cuda:1 "[1,512]" 0.5 0.1 "[-1]" 256 2 0.05 &
# python kge/cli_debug.py models/YAGO/AdaE_auto.yaml cuda:2 "[1,512]" 0.5 0.1 "[-1]" 512 2 0.05 &
# python kge/cli_debug.py models/WNRR18/AdaE_auto.yaml cuda:1 "[1,256]" 0.5 0.6 "[-1]" 256 1 0.012 &
